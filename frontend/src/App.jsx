...
function App() {
  ...
  async function handleSubmit() {
    await axios
      .post("http://localhost:4000/recipe", { data: data })
      .then((response) => {
  ...
  return (
    <div className="flex flex-col justify-start items-center gap-5 p-10 md:w-[80vw] m-auto">
      <h1 className="text-3xl font-semibold">Recipe Search</h1>
        ...
        {recipes != undefined ? (
          <div>
            ...
            <div className="flex flex-wrap justify-center items-start gap-5">
              {recipes.map((recipe) => {
                return (
                  <div className="h-96 overflow-auto border-[1px] p-5 rounded-md w-[400px] ">
                    ...
                    <div className="py-4">
                      ...
                      {recipe.ingredients.map((ingredient) => {
                        return (
                          <p className="text-gray-600 flex justify-start items-center gap-3">
